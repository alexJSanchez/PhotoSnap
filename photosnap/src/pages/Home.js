			...
			<div className="App">
				<main>
					...
					>
						...
						<div
							id="main-card-bottom"
							className="tablet:flex tablet:flex-col tablet:justify-center tablet:col-start-1 tablet:row-start-1 tablet:col-end-3 text-white bg-black pt-[4.5rem] pr-[1.5rem] pb-[4.5rem] pl-[2.063rem]"
						>
							<h2 className="text-white text-[32px] tablet:text-[40px] tablet:pr-[54px] font-bold leading-[40px] tablet:leading-[48px] tracking-[3.333px] uppercase">
